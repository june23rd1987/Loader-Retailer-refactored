...
import com.inducesmile.retailer.adapters.CheckRecyclerViewAdapter;
import com.inducesmile.retailer.entities.ProductObject;
import com.inducesmile.retailer.helpers.MySharedPreference;
import com.inducesmile.retailer.helpers.SimpleDividerItemDecoration;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shoppingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent shoppingIntent = new Intent(CheckoutActivity.this, MainMenuActivity.class);
