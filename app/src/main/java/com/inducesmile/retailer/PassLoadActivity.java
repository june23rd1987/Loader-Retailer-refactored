...
public class PassLoadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dealer_pass_load);
        ...
        sendLoadIntent = new Intent(PassLoadActivity.this, PassLoadConfirmActivity.class);
        ...
        mbackbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backIntent = new Intent(PassLoadActivity.this, MainMenuActivity.class);
        ...
        msendLoadbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(validnum) {
                    ...
                    sendLoadIntent.putExtra("ProdCode", "PASSLOAD " + phonenum + " " + productAmount);
    ...
    public boolean onSupportNavigateUp() {
        ...
        startActivity(new Intent(PassLoadActivity.this, MainMenuActivity.class));
        overridePendingTransition(R.anim.slideinright, R.anim.slideinleft);
        return true;
    }
